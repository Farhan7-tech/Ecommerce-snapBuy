...
import com.ecommerce.sbEcommerce.security.jwt.AuthEntryPointJwt;
import com.ecommerce.sbEcommerce.security.jwt.AuthTokenFilter;
import com.ecommerce.sbEcommerce.security.service.UserDetailsServiceImpl;
        ...
        http.cors(cors -> cors.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/api/auth/**").permitAll()
                                ...
                                .requestMatchers("api/order/users/**").permitAll()
